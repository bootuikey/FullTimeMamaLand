...
//     String vuid = "769312c218";
    ...
    private void startLeCloudLive() {
        ...
        intent.putExtra(PlayActivity.DATA, LetvParamsUtils.setLiveParams(streamId, liveId, rb2.isChecked(), false, false));
        startActivity(intent);
    }
    ...
    private void startLeCloudActionLive() {
        ...
        intent.putExtra(PlayActivity.DATA, LetvParamsUtils.setActionLiveParams(etActionId.getText().toString().trim(), false));
        startActivity(intent);
    }
