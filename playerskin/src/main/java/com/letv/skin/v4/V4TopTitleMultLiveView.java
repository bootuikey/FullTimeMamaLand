...
//        requestActionConfig();
    ...
    private void requestInformMessage() {
        workerController.tipOff(uiPlayContext.getActivityId(), new BaseCallback<LinePeople>() {
    ...
    private void requestLinePeople() {
        ...
        workerController.getLinePeople(uiPlayContext.getActivityId(), new BaseCallback<LinePeople>() {
